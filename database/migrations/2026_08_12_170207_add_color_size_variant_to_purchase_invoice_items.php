...
return new class extends Migration
{
    public function up(): void
    {
        Schema::table('purchase_invoice_items', function (Blueprint $table) {
            ...
            if (!Schema::hasColumn('purchase_invoice_items', 'color_id')) {
                $table->unsignedBigInteger('color_id')->nullable()->after('product_unit_id');
            }
            
            // if (!Schema::hasColumn('purchase_invoice_items', 'size_id')) {
            //     $table->unsignedBigInteger('size_id')->nullable()->after('color_id');
            // }
            
            if (!Schema::hasColumn('purchase_invoice_items', 'product_variant_id')) {
