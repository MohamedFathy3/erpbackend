...
return new class extends Migration {
    public function up(): void {
        Schema::create('employee_payrolls', function (Blueprint $table) {
            ...
            $table->json('adjustments')->nullable(); $table->text('notes')->nullable(); $table->foreignId('tenant_id')->nullable()->constrained('tenants')->nullOnDelete(); $table->timestamps();
            $table->index(['employee_id', 'period_end']); $table->unique(['employee_id', 'period_start', 'period_end']);
        });
        Schema::create('employee_advances', function (Blueprint $table) {
            ...
            $table->text('notes')->nullable(); $table->foreignId('tenant_id')->nullable()->constrained('tenants')->nullOnDelete(); $table->timestamps();
        ...
        Schema::create('employee_advance_payments', function (Blueprint $table) {
            ...
            $table->foreignId('tenant_id')->nullable()->constrained('tenants')->nullOnDelete(); $table->timestamps();
        });
        Schema::create('employee_financial_transactions', function (Blueprint $table) {
            ...
            $table->text('notes')->nullable(); $table->string('recorded_by_name')->nullable(); $table->foreignId('tenant_id')->nullable()->constrained('tenants')->nullOnDelete(); $table->timestamps();
