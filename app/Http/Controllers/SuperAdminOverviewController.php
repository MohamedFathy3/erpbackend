...
class SuperAdminOverviewController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $recent = DB::table('activity_log')
            ...
            ->select('activity_log.id', 'activity_log.description', 'activity_log.subject_type', 'activity_log.subject_id', 'activity_log.causer_type', 'activity_log.causer_id', 'activity_log.created_at', DB::raw('COALESCE(admins.name, users.name, users.username, "System") as actor_name'))
