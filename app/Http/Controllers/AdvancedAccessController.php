...
{
    public function permissions(Request $request) { abort_unless($request->user()?->hasPermission('roles.manage'), 403); return response()->json(['data'=>Permission::orderBy('module')->orderBy('key')->get()]); }
