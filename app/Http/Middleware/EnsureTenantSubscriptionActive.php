...
class EnsureTenantSubscriptionActive
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        if ($tenant->status === 'suspended' || $tenant->subscription_status === 'suspended') return response()->json(['message'=>'Your workspace is suspended. Please contact support.','code'=>'tenant_suspended'], 403);
