...
class CheckModuleEnabled
{
    ...
    private function moduleForPath(string $path): ?string
    {
        ...
        $modules = [
            ...
            'purchasing' => ['supplier', 'suppliers', 'purchase', 'purchases', 'purchase-return', 'purchase-returns'],
            'finance' => ['finance', 'bank', 'bank-movement', 'revenue', 'currency', 'tax', 'treasury', 'treasury-movement', 'accounts', 'journal'],
